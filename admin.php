...
<div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Pyramid 36</a>
            <ul>
              ...
              <li><a class="drop" href="#">Pyramid 13-18</a>
                <ul>
                  <li><a href="com_13.php">Pyramid_PHP13</a></li>
          ...
          <li><a class="drop" href="https://www.facebook.com/jakkapatcom/">Facebook</a>
          </li>
          <li><a class="drop" href="https://www.youtube.com/channel/UCWrZ6-Gu2lkYqHD2vtHjufw/featured">Youtube</a>
          </li>
        </ul>
      </nav> 
    </header>
  ...
  <h3 class="container"><p><a href=#>Member</a></p>
    <table border=2>
      <?php 
      require('db.php');
      ...
      echo $object->id ."</td><td>". $object->username."</td><td>" .$object->password."</td><td>" . $object->status .
      "</td><td>".'<form action=del.php method=get>
      <input type=submit>
      </form>'. "<br/>" ;
      echo "</td></tr>";
      } 
